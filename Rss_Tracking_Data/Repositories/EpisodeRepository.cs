...
namespace Rss_Tracking_Data.Repositories
{
    public interface IEpisodeRepository
    {
        ...
        List<Episode> GetEpisodesByCreator(Creator creator);
    ...
    public class EpisodeRepository : IEpisodeRepository
    {
        ...
        public List<Episode> GetEpisodesByCreator(Creator creator) => _context.Episodes.Where(x => x.CreatorId == creator.Id).ToList();
